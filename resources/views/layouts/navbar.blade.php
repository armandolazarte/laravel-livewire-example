    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs(['dropdowns*', 'dropdowns-ciudades*', 'dependant-select*', 'select-dependiente*']) ? 'active' : '' }}" href="#" id="dropdowns" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdowns</a>
                    <div class="dropdown-menu" aria-labelledby="dropdowns">
                        ...
                        <a class="dropdown-item {{ request()->routeIs('select-dependiente') ? 'active' : '' }}" href="{{ route('select-dependiente') }}">Select Dependiente</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
